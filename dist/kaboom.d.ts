...
export type KaboomCtx = {
  ...
  render(cb: () => void): void;
  collides(t1: string, t2: string, f: (a: GameObj, b: GameObj) => void): void;
  overlaps(t1: string, t2: string, f: (a: GameObj, b: GameObj) => void): void;
  clicks(tag: string, f: (a: GameObj) => void): void;
  camPos(p: Vec2): Vec2;
